...
var i;
var slides = document.getElementsByClassName("mySlidesLightbox");
...
/* Display the URL - change "none" to "block" */
...
for (i = 0; i < 7; i++) {
	...
	document.getElementById("genres" + i).innerHTML = "  " + msg.genres[i].name;}
		...
		/* Less that 7 movie genres returned - blank out the rest of the values */
...
{
/* Less that 24 movies returned - blank out the rest of the values */
document.getElementById("name" + i).innerHTML = "";
document.getElementById("name" + i).style.display = "none";
...
/*ocument.getElementById("profile_path").style.display = "block";
document.getElementById("profile_path").src = "https://image.tmdb.org/t/p/w45" + msg.profile_path;*/
